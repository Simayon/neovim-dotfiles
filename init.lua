...
vim.api.nvim_create_autocmd('BufEnter', {
  ...
  callback = function()
    ...
    -- Check if it's a normal file, not the dashboard, and not an empty buffer
    if buftype == '' and filetype ~= 'dashboard' and bufname ~= '' and not vim.g.neotree_opened then
        ...
        callback = function(event)
          ...
          local map = function(keys, func, desc)
            vim.keymap.set('n', keys, function()
              ...
              vim.cmd 'normal! zz' -- Center the line after executing the function
          ...
          -- Jump to the functions calling the current word under the cursor
          map('gc', require('telescope.builtin').lsp_incoming_calls, '[G]oto [C]alling Functions')
