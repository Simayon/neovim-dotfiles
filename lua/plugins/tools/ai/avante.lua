return {
	...
	opts = {
		...
		providers = {
			-- Migrated custom provider configuration
			["my-custom-provider"] = {
				...
				parse_response = function(data_stream, event_state, opts)
					...
					for _, chunk in ipairs(chunks) do
						if chunk:match("^data: ") then
							...
							if
								json_chunk.choices
								and json_chunk.choices[1]
								and json_chunk.choices[1].delta
								and json_chunk.choices[1].delta.content
							then
							...
							elseif
								json_chunk.choices
								and json_chunk.choices[1]
								and json_chunk.choices[1].finish_reason
							then
